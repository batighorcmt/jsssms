...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action'])) {
        ...
        if ($action === 'add') {
            ...
            $student_group = test_input($_POST['student_group']);
            $year = test_input($_POST['year']);

            $stmt = $conn->prepare("INSERT INTO students (student_id, roll_no, student_name, father_name, mother_name, gender, mobile_no, religion, nationality, date_of_birth, blood_group, village, post_office, upazilla, district, status, class, section, `student_group`, year) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("sssssssssssssssiiisi", $student_id, $roll_no, $student_name, $father_name, $mother_name,  $gender, $mobile_no, $religion, $nationality, $date_of_birth,
  $blood_group, $village, $post_office, $upazilla, $district,  $status, $class_id, $section_id, $student_group, $year);
            ...
            $stmt = $conn->prepare("UPDATE students SET roll_no=?, student_name=?, father_name=?, mother_name=?, gender=?, mobile_no=?, religion=?, nationality=?, date_of_birth=?, blood_group=?, village=?, post_office=?, upazilla=?, district=?, status=?, class=?, section=?, `student_group`=?, year=? WHERE student_id=?");
            $stmt->bind_param("sssssssssssssssssiiss", $roll_no, $student_name, $father_name, $mother_name, $gender, $mobile_no, $religion, $nationality, $date_of_birth, $blood_group, $village, $post_office, $upazilla, $district, $status, $class_id, $section, $student_group, $year, $student_id);
            $stmt->execute();
            header("Location: manage_students.php");
            exit();
                    ...
                    <tr>
                        ...
                        <td>
                            <button 
                                ...
                                data-student_group="<?= htmlspecialchars($row['student_group']) ?>"
      ...
      <form method="post" id="addStudentForm">
        ...
        <div class="modal-body">
          <div class="row g-3">
            ...
            <div class="col-md-3">
              <label for="blood_group" class="form-label">Blood student_group</label>
            ...
            <div class="col-md-2">
              <label for="student_group" class="form-label">student_group</label>
      ...
      <form method="post" id="editStudentForm">
        ...
        <div class="modal-body">
          <div class="row g-3">
            ...
            <div class="col-md-3">
              <label for="edit_blood_group" class="form-label">Blood student_group</label>
            ...
            <div class="col-md-2">
              <label for="edit_student_group" class="form-label">student_group</label>
              <input type="text" name="student_group" id="edit_student_group" class="form-control">
            </div>
            <div class="col-md-2">
...
<script>
  ...
  function openEditModal(student) {
    ...
    document.getElementById('edit_student_group').value = student.student_group;
